...
require('jquery.event.move/js/jquery.event.move.js');
import './vendor/numinate.min';
// import './vendor/slider';
// import './vendor/revolution.tools.min';
// import './vendor/rs6.min';
// require('revslider/js/jquery.themepunch.revolution.min.js');
// require('revslider/js/jquery.themepunch.tools.min.js');
